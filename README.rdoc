...
We're going to build a simple survey tool. With the following requirements:
  ...
  We don't need to worry about user authentication but you may stub this out if you wish
  ...
  We should keep track of when each of the survey responses are saved

  We should display the results of the survey on the home screen with the percentage of yes and no responses.
...
User can respond to any survey without login;
User needs to login first to create survey question;
